...
DEFAULT_CONFIG = {
    "bot_token": "8438904762:AAEPeeChpuiPcrywlW40tjzrO2XwR7Ogy8E",
...
def settings():
    ...
    if request.method == "POST":
        ...
        save_cfg()
        msg = "Đã lưu cấu hình. Nếu đổi token ENV trên Render thì Manual Deploy lại."
    ...
    <div class="card">
      <h2>🎁 Free & Bonus</h2>
      <label><input style="width:auto" type="checkbox" name="free_mode_enabled" {free_checked}> Bật dự đoán free</label>
