...
UPDATE FIX 2026-06-13:
- Fix lỗi 500 Internal Server Error ở /settings do f-string placeholder thuật toán.
- Nâng cấp engine_md5.py sang OMNI CAU V18: multi-hash SHA512/SHA3/BLAKE2, phân tích cầu bệt/đảo/2-1/mirror/byte wave/nibble entropy/multi-vote.
- Thêm Backup Full Data JS trong Admin > Backup: tải kingbot_full_backup.js và import lại để giữ toàn bộ config + database + thuật toán admin.
- Import hỗ trợ file .js dạng window.KINGBOT_FULL_BACKUP = {...}; hoặc .json thuần.
